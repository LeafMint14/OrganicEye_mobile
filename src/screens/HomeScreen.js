    ...
    unsubscribeUser = onSnapshot(userDocRef, (docSnap) => {
      if (docSnap.exists()) {
        ...
        if (piId) {
          ...
          setRecentActivities([]);
          setStats({ detectionsToday: 0, activeFields: 0, cropHealth: 'N/A' });
          setLoading(false);
        }
      } else {
        setLoading(false);
...
const styles = StyleSheet.create({
  ...
  profileButton: { width: 50, height: 50, borderRadius: 25, overflow: 'hidden', borderWidth: 2, borderColor: 'rgba(255, 255, 255, 0.5)' },
  profileImage: { width: '100%', height: '100%' },
  statsContainer: { flexDirection: 'row', paddingHorizontal: 20, marginBottom: 30, gap: 12 },
  statCard: { flex: 1, padding: 20, borderRadius: 15, alignItems: 'center', elevation: 2 },
  ...
  actionCard: { width: '48%', padding: 20, borderRadius: 15, alignItems: 'center', elevation: 2 },
  actionIcon: { marginBottom: 10 },
  actionTitle: { fontSize: 14, fontWeight: '600', textAlign: 'center' },
  activitiesList: { gap: 12 },
  activityItem: { padding: 15, borderRadius: 10, flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', elevation: 1 },
  activityContent: { flex: 1 },
  activityTitle: { fontSize: 16, fontWeight: '600', marginBottom: 4 },
  activityTime: { fontSize: 14 },
  statusBadge: { paddingHorizontal: 10, paddingVertical: 5, borderRadius: 12, marginLeft: 10 },
  statusText: { fontSize: 12, fontWeight: '600', color: '#ffffff' },
  emptyCard: { padding: 20, borderRadius: 15, alignItems: 'center', justifyContent: 'center', minHeight: 150 },
